(function(){
    ...
    for (var i = 0; i < scene25Cont.length; i++) {
        scene25Cont[i].addEventListener('click', function() {
            alert(`Thank you taking the time to user test. Please message Maggie back once you are done and she will ask you follow up questions!`)
            document.getElementById('results').style.display = 'block';
            document.getElementById('results').innerHTML = `Results: Money: $${money}, Happiness: ${happiness}, Grades: ${grades}`
